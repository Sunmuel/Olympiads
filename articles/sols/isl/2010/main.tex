...
Since $\triangle DEF$ is an orthic triangle, $\measuredangle CFA = \measuredangle
	...
	ACD = \measuredangle BFD$. Besides that, $A$, $F$, $B$ are colinear, as are
$D$, $F$, $Q$. Hence, $\measuredangle AFQ = \measuredangle BFD = \measuredangle
	ACD$. However, $APCB$ is cyclic, so $\measuredangle APB = \measuredangle ACB =
